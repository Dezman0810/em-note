...
/**
 * Один абзац на пункт чек-бокса (Enter даёт новый пункт, а не второй абзац в той же ячейке).
 * Без input rules — чекбоксы только через кнопку «Чек-бокс», не по вводу "- [ ]".
 */
